...
import (
	context "context"
	time_event "github.com/Kenji-Uema/guestSimulator/internal/domain/dto/time_event"
...
type ClockServiceClient interface {
	Now(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*time_event.TimeEvent, error)
}
...
func (c *clockServiceClient) Now(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*time_event.TimeEvent, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(time_event.TimeEvent)
...
type ClockServiceServer interface {
	Now(context.Context, *emptypb.Empty) (*time_event.TimeEvent, error)
...
func (UnimplementedClockServiceServer) Now(context.Context, *emptypb.Empty) (*time_event.TimeEvent, error) {
